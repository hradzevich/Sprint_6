...
class TestHeaderPage:
    ...
    @allure.description(
        "На странице ищем логотип Яндекс, кликаем на него, переходим в новую вкладку и проверяем, что URL соответствует главной странице Дзен"
    )
    ...
    @allure.description(
        "На странице заказа ищем логотип Самокат, кликаем на него и проверяем, что URL соответствует главной странице Самоката"
    )
